...
$consultaUsuario = $conexion->prepare("SELECT * FROM usuarios WHERE documento = :documento");
...
if (isset($_POST["btn-actualizar"])) {
    ...
    $consultaActualizar = $conexion->prepare("UPDATE usuarios SET nombre = :nombre, apellido = :apellido, correo_electronico = :email, celular = :celular, direccion = :direccion, id_genero = :genero, id_rol = :rol, id_estado = :estado, id_tipdocu = :id_tipdocu, foto = :foto WHERE documento = :documento");
                                ...
                                <h2>Actualización de Usuarios</h2>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="imagen" style="font-size: 18px;">Actualizar imagen:</label>
                                        ...
                                        <br><div class="row" style="font-size: 25px;">
                                            <button type="submit" value="actualizar" name="btn-actualizar" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">ACTUALIZAR</button>
                                        </div>
