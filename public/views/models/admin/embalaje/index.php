...
// Consulta SQL para obtener la información de todos los Embalaje
            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./index.php">Listar Embalaje</a></li>
                            <li><a href="./crear.php">Crear Embalaje</a></li>
                        </ul>
                    </li>
                    <!-- MODULO DE GENEROS -->
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Embalaje</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row" style="font-size: 25px;">
                                    <a href="./crear.php" class="btn btn-margin col-4" style="background-color: #0097B2; color:#ffff;">Crear Embalaje</a><br>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($embala as $embalas) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar.php?id_embala=<?php echo $embalas['id_embala']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E1C022; color:#fff" onclick="return confirm('¿Está seguro de actualizar este Embalaje?')">
                                                                <span class="icon"><i class="fas fa-pencil-alt"></i></span>
                                                                <span class="text">ACTUALIZAR</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar.php?id_embala=<?php echo $embalas['id_embala']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E0322A; color:#fff" onclick="return confirm('¿Está seguro de eliminar este Embalaje?')">
