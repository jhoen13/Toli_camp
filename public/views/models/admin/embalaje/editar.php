...
if (isset($_GET['id_embala']) && is_numeric($_GET['id_embala']) && $_GET['id_embala'] > 0) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM embalaje WHERE id_embala = :id_embala");
...
if ((isset($_POST["registro"])) && ($_POST["registro"] == "formu")) {
    ...
    if (empty($embalaje)) {
        ...
        // Actualización
        $updatesql = $conexion->prepare("UPDATE embalaje SET embalaje = :embalaje WHERE id_embala = :id_embala");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="modal-title" id="exampleModalLabel">Actualizar Embalaje</h2>
                                    <table id="example3" class="display text-center" style="min-width: 845px">
                                        <form action="" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="registro" value="formu" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">EDITAR EMBALAJE</button>    
                                            </div>
                                        </form>
                                    </table>
                                </div>
