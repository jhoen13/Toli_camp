...
if ((isset($_POST["registro"])) && ($_POST["registro"] == "formu")) {
    ...
    if ($genero == "") {
        ...
        $insertsql = $conexion->prepare("INSERT INTO genero( genero) VALUES ( '$genero');");
        $insertsql->execute();
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <h2 class="modal-title" id="exampleModalLabel">Crear Genero</h2>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" name="registro" value="formu" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">CREAR GENERO</button>  
                                        </div>
                                    </form>
                                    </table>
                                </div>
