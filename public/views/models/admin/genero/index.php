            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href=" ./index.php ">Lista Generos</a></li>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Generos</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row" style="font-size: 25px;">
                                    <a href="./crear.php" class="btn btn-margin col-4" style="background-color: #0097B2; color:#ffff;">Crear un Genero</a><br>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($genero as $gen) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar.php?id_genero=<?php echo $gen['id_genero']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E1C022; color:#fff" onclick="return confirm('¿Está seguro de actualizar este Genero?')">
                                                            <span class="icon"><i class="fas fa-pencil-alt"></i></span>
                                                            <span class="text">ACTUALIZAR</span>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar.php?id_genero=<?php echo $gen['id_genero']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E0322A; color:#fff" onclick="return confirm('¿Está seguro de eliminar este Genero?')">
