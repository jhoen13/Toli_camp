...
if (isset($_GET['id_genero']) && is_numeric($_GET['id_genero']) && $_GET['id_genero'] > 0) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM genero WHERE id_genero = :id_genero");
...
if ((isset($_POST["registro"])) && ($_POST["registro"] == "formu")) {
    ...
    $validar = $conexion->prepare("SELECT * FROM genero WHERE genero = :genero");
    ...
    if (empty($genero)) {
        ...
        // Actualización
        $updatesql = $conexion->prepare("UPDATE genero SET genero = :genero WHERE id_genero = :id_genero");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <h2 class="modal-title" id="exampleModalLabel">Actualizar Genero</h2>
                                    <table id="example3" class="display text-center" style="min-width: 845px">
                                        <form action="" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="registro" value="formu" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">EDITAR GENERO</button>                                            
                                            </div>                
                                        </form>
                                    </table>
                                </div>
