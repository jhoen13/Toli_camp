...
if ((isset($_POST["registro"])) && ($_POST["registro"] == "formu")) {
    ...
    $validar = $conexion->prepare("SELECT * FROM roles WHERE tipo_rol = '$tipo_rol'");
    $validar->execute();
    ...
    if ($filaa1) {
        ...
        $insertsql = $conexion->prepare("INSERT INTO roles( tipo_rol) VALUES ( '$tipo_rol');");
        $insertsql->execute();
                        ...
                        <div class="card">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <input id="tipo_rol" type="text" class="form-control" name="tipo_rol" placeholder="Ingresa un rol">
                                </div>

                                <div class="row" style="font-size: 25px;">
                                        <button type="submit" name="registro" value="formu" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">CREAR USUARIO</button>
                                </div>
                            </form>
                                </div>
                            </div>
