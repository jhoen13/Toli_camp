                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row" style="font-size: 25px;">
                                    <a href="./crear.php" class="btn btn-margin col-4" style="background-color: #0097B2; color:#ffff;">Crear un Rol</a><br>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($rol as $roles) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar.php?id_rol=<?php echo $roles['id_rol']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E1C022; color:#fff" onclick="return confirm('¿Está seguro de actualizar este Rol?')">
                                                            <span class="icon"><i class="fas fa-pencil-alt"></i></span>
                                                            <span class="text">ACTUALIZAR</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar.php?id_rol=<?php echo $roles['id_rol']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E0322A; color:#fff" onclick="return confirm('¿Está seguro de eliminar este Rol?')">
