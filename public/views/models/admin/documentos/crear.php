...
if ((isset($_POST["registro"])) && ($_POST["registro"] == "formu")) {
    ...
    $validar = $conexion->prepare("SELECT * FROM tipdocu WHERE tipdocu = '$tipoocu'");
    $validar->execute();
    ...
    if ($tipoocu == "") {
        ...
        $insertsql = $conexion->prepare("INSERT INTO tipdocu( tipdocu) VALUES ( '$tipoocu');");
        $insertsql->execute();
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2>Creacion de T.P Documento</h2>
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <label for="tipoocu">Nombre Del Documento</label>
                                    <input id="tipoocu" type="text" class="form-control" name="tipoocu" placeholder="Ingresa un documento">
                                </div>

                                <div class="row" style="font-size: 25px;">
                                        <button type="submit" name="registro" value="formu" class="btn_ing btn btn-margin col-4 mx-auto" style="background-color: #0097B2; color: #ffff;">CREAR T.P DOCUEMNTO</button>
                                </div>
                            </form>
                                </div>
                            </div>
