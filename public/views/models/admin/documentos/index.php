        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">T.P Documentos</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row" style="font-size: 25px;">
                                    <a href="./crear.php" class="btn btn-margin col-4" style="background-color: #0097B2; color:#ffff;">Crear un T.P Documento</a><br>
                                </div>
                                    ...
                                    <table id="example3" class="display text-center" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <?php foreach ($documento as $docume) { ?>
                                                    ...
                                                    <td>
                                                        <a href="editar.php?id_tipdocu=<?php echo $docume['id_tipdocu']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E1C022; color:#fff" onclick="return confirm('¿Está seguro de actualizar este T.P Documento?')">
                                                            <span class="icon"><i class="fas fa-pencil-alt"></i></span>
                                                            <span class="text">ACTUALIZAR</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar.php?id_tipdocu=<?php echo $docume['id_tipdocu']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E0322A; color:#fff" onclick="return confirm('¿Está seguro de eliminar este T.P Documento?')">
