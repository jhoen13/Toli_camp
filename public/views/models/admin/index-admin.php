            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-6">
                        <div class="widget-stat card bg-danger" style="background-color:#0097B2 !important;">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="../../../assets/img/usuarios.png" style="border-radius: 10px; width: 70px;" class="la la-users sd-shape"></img>
                                    </span>
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-6">
                        <div class="widget-stat card bg-danger" style="background-color:#0097B2 !important;">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="../../../assets/img/ventas.png" style="border-radius: 10px; width: 70px;" class="la la-users sd-shape"></img>
                                    </span>
                                    <div class="media-body text-white text-end">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-6">
                        <div class="widget-stat card bg-danger" style="background-color:#0097B2 !important;">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="../../../assets/img/img_produc/Productos-agricolas.png" style="border-radius: 10px; width: 80px;" class="la la-users sd-shape"></img>
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        try {
                                            $conteoproductos = $con->query($conteoproductos);
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-6">
                        <div class="widget-stat card bg-danger" style="background-color:#0097B2 !important;">
                            <div class="card-body p-4">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="../../../assets/img/embalajes.png" style="border-radius: 10px; width: 70px;" class="la la-users sd-shape"></img>
                                    ...
                                    <div class="media-body text-white text-end">
                                        ...
                                        try {
                                            $conteoEmbala = $con->query($conteoEmbala);
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Logueados</a></li>
                    </ol>
                </div>
                <div class="row">
