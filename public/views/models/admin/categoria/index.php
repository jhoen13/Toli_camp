            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Registradas</a></li>
                    </ol>
                </div>
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row" style="font-size: 25px;">
                                    <a href="./crear.php" class="btn btn-margin col-4" style="background-color: #0097B2; color:#ffff;">Crear una Categoria</a><br>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($categoria as $catego) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editar.php?id_categoria=<?php echo $catego['id_categoria']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E1C022; color:#fff" onclick="return confirm('¿Está seguro de actualizar esta Categoria?')">
                                                            <span class="icon"><i class="fas fa-pencil-alt"></i></span>
                                                            <span class="text">ACTUALIZAR</span>
                                                    </td>
                                                    <td>
                                                        <a href="eliminar.php?id_categoria=<?php echo $catego['id_categoria']; ?>" class="btn shadow btn-xxl sharp" style="background-color:#E0322A; color:#fff" onclick="return confirm('¿Está seguro de eliminar esta Categoria?')">
