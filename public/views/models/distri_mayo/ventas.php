...
$docu_distri_mino = $_SESSION['document'];
...
// Terminar la venta
if (isset($_POST['terminar_venta']) && isset($_SESSION['carrito']) && count($_SESSION['carrito']) > 0 && isset($_POST['usuario'])) {
    ...
    $sql_insert_venta->execute([$id_venta, $fecha_venta, $total_venta, $docu_distri_mino, $docu_usuario]);
                            ...
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="usuario" id="usuario" required>
                                        ...
                                        ?>
                                            <option value="<?php echo $user['documento'] ?>"><?php echo $user['nombre'] ?> <?php echo $user['apellido'] ?></option>
                                        <?php
                                        };
                                        ?>
                                    </select>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $producto['documento']; ?></td>
