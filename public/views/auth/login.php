        ...
        <form method="POST" enctype="multipart/form-data" autocomplete="off" action="../../controller/inicio.php">
            <div class="">
                ...
                <div class="input-group col">
                    ...
                    <div class="input-group-append" style="font-size: 1rem; background: linear-gradient(to right, #4ca1af, #c4e0e5); color: white;">
            ...
            <div style="  text-align: center;">
                <button type="submit" value="registrar" name="btn-ingresar" class="btn_ing">INICIAR SESIÓN</button><br><br>
                <a class="ingresar" href="rectificacion.html" style="color: black;text-align: right;">Olvidé mi contraseña</a><br>
                <a class="ingresar" href="registro.php" style="color: black; text-align: left;">Registrarse</a>
